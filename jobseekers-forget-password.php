...

{
	...
	{	
		...
		$query="SELECT * FROM `ss_jobseekers` WHERE `email`='$email' ";	
		...
		
		{
		  ...
		  '.$emailfooter;
			...
			{	
				...
				$query_insert = "UPDATE `ss_jobseekers` SET password = '$password' WHERE `id`='$userid'";
...
<div class="rws-userpages">
	<div class="rws-userpagesinner">
		<div class="container"><h1>Jobseeker Forgot Password?</h1></div>
	</div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <a href="javascript:void(0)">Jobseeker Forgot Password?</a>
            </div>
        </div>
    </div>
</div>         
        ...
        <div class="rws-maincontentinn">
            ...
            <div class="rws-fields">
                ...
                <div class="row">
                	...
                	<div class="col-xs-6"><a href="jobseekers-login.php">Login</a></div>

                    <div class="col-xs-6" style="text-align:right;"><a href="jobseekers-register.php">Register</a></div>
