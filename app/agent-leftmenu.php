<div class="rws-sfsection">
    <div class="rws-userimgpic">
    	<?php if(!empty($_SESSION["AGN"]['Picture'])) { echo '<img src="'.$baseurl.$_SESSION["AGN"]['Picture'].'" title="" />'; } else {  echo '<img src="'.$baseurl.'images/no-pic-com-logo.jpg" title="" />'; } ?>
    </div>    
    <?php if(!empty($_SESSION["AGN"]['Company'])) { echo '<p class="rws-pheadlineemp text-center">'.$_SESSION["AGN"]['Company'].'</p>'; }?>
    </h4>
    
    <ul class="rws-userplinks">
    
    	<?php if($_SESSION["AGN"]['SubType']=="SuperAdmin") { ?>
        <!-- <li><a href="<?php echo $baseurl; ?>agent-dashboard.php"><i class="fa fa-columns"></i> Dashboard</a></li> -->
        <li><a href="<?php echo $baseurl; ?>agent-vacancy-list.php"><i class="fa fa-list-alt"></i> Dashboard</a></li>
        <li><a href="<?php echo $baseurl; ?>agent-edit-profile.php"><i class="fa fa-user"></i> Agent Profile</a></li>
      <!--     <li><a href="<?php echo $baseurl; ?>employer-details.php?emp_id=<?php echo $_SESSION["AGN"]['ID']; ?>"><i class="fa fa-user"></i> View Company Profile</a></li>    -->
     <!--       <li><a href="javascript:void(0);" data-toggle="modal" data-target="#postjoblinks"><i class="fa fa-plus-square"></i> Post a Job</a></li>    -->
        ...
        <!-- <li><a href="<?php echo $baseurl; ?>agent-applicant-list.php"><i class="fa fa-list-alt"></i> Assigned Job Applicants</a></li> -->
    <!--    <li><a href="<?php echo $baseurl; ?>employer-team-list.php"><i class="fa fa-users"></i> Manage Team</a></li>  -->
        <li><a href="<?php echo $baseurl; ?>agent-change-password.php"><i class="fa fa-lock"></i> Change Password</a></li>
        <!-- <li><a href="<?php echo $baseurl; ?>employer-setting-delete-account.php"><i class="fa fa-cog"></i> Delete Account</a></li>  -->
        <?php } ?>
        
        <?php if($_SESSION["AGN"]['SubType']=="Admin") { ?>
        <li><a href="<?php echo $baseurl; ?>agent-dashboard.php"><i class="fa fa-columns"></i> Dashboard</a></li>      
  <!--      <li><a href="javascript:void(0);" data-toggle="modal" data-target="#postjoblinks"><i class="fa fa-plus-square"></i> Post a Job</a></li>    -->
        <li><a href="<?php echo $baseurl; ?>employer-post-marine-job.php"><i class="fa fa-plus-square"></i> Post a Job</a></li>
        <li><a href="<?php echo $baseurl; ?>agent-job-list.php"><i class="fa fa-list-alt"></i> Manage Posted Jobs</a></li>
        <li><a href="<?php echo $baseurl; ?>agent-applicant-list.php"><i class="fa fa-list-alt"></i> Manage Job Applicants</a></li> 
        <?php } ?>
        
        <?php if($_SESSION["AGN"]['SubType']=="Standard") { ?>
        <li><a href="<?php echo $baseurl; ?>agent-dashboard.php"><i class="fa fa-columns"></i> Dashboard</a></li>        
        <li><a href="<?php echo $baseurl; ?>agent-job-list.php"><i class="fa fa-list-alt"></i> Manage Posted Jobs</a></li>
        <li><a href="<?php echo $baseurl; ?>agent-applicant-list.php"><i class="fa fa-list-alt"></i> Manage Job Applicants</a></li> 
        <?php } ?>
