...
<?php include("includes/config.php");  $gtpage = "Agent"; 
checkagentlogin(); 
...
<div class="rws-userpages">
	<div class="rws-userpagesinner">
		<div class="container"><h1>Hello <?php echo $_SESSION["AGN"]['Firstname']; ?></h1></div>
	</div>
</div>
...
<div class="rws-maincontentinner">
    ...
    <div class="row">
    	<div class="col-md-3">
        	<?php 
            include("app/agent-leftmenu.php");
             ?>        	
        </div>
        ...
        <?php
    		...
    		$query="SELECT t1.*, IFNULL(t2.totalapplicants,0) as totalapplicants FROM ss_employer_jobs as t1 $queryjoin WHERE emp_id=".$_SESSION["AGN"]['ID']." ORDER BY add_date DESC LIMIT 0, 5";
        ...
        <div class="col-md-9">
        	<div class="rws-module">
                <div class="mtitle">Recent Assigned Vacancies <span class="rws-addnewitem">
                ...
                <div class="rws-mcontent">
                    ...
                    <?php } else { echo '<div id="rws-formfeedback">There is no vacancy for you.</div>'; } ?>
