...
<div class="rws-userpages">
	<div class="rws-userpagesinner">
		<div class="container"><h1>Jobseeker Account Validation</h1></div>
	</div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <a href="javascript:void(0)">Jobseeker Account Validation</a>
            </div>
        </div>
    </div>
</div>         
...
<div class="rws-maincontentinner">
	...
	$query_val = "SELECT * FROM `ss_jobseekers` WHERE `id` =".$validateid;
...

	{
		...
		{	
			...
			$qvalup = "UPDATE `ss_jobseekers` SET `validate` = '1' WHERE `id` =".$validateid;

			$result_valup = $db->query($qvalup);

			$error_message = '<div id="rws-formsuccess"><p>Hello User,<br /><br />			

			Your '.$sitename.' account has been successfully validated. <br/><br/>	

			<a  style="background-color: blue;padding: 10px;border-radius: 50px; color: white !important;      font-weight: 600;"
             href="jobseekers-login.php">Click For Login</a>
