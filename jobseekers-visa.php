...
{		
    ...
    $issue_date1 = $_POST['issue_date1'];
    $expire_date1 = $_POST['expire_date1'];


    if(!empty($_GET['edit'])){

       
        $update="UPDATE ss_jobseekers_visa SET js_id = '".$_SESSION["USER"]['ID']."',country = '".$country."', visa_type = '".$visa_type."', issue_date1 = '".$issue_date1."', expire_date1 = '".$expire_date1."'
        where id='".$_GET['edit']."' "; 

        $updatevisa = $db->query($update);	

    if($updatevisa){

        echo "<script>alert('Record Updated Successfully');window.location.href='jobseekers-visa.php';</script>";
    ...
    $insert = "INSERT INTO `ss_jobseekers_visa` SET js_id = '".$_SESSION["USER"]['ID']."', country = '".$country."', visa_type = '".$visa_type."', issue_date1 = '".$issue_date1."', expire_date1 = '".$expire_date1."'"; 
    ...
    if($update_result){
            ...
            echo "<script>document.location.href='".$baseurl."jobseekers-visa.php'</script>"; 
    }else{
...
if(!empty($_GET['edit'])){
    ...
    $edit="select * FROM ss_jobseekers_visa where id='".$_GET['edit']."' ";
    $editm = $db->query($edit);	
    $eres = $editm->rows;
...
<div class="rws-maincontentinner">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
          ...
          <?php
    		$query="SELECT * FROM ss_jobseekers_visa WHERE js_id=".$_SESSION["USER"]['ID']." ";
        ...
        <div class="rws-module">
               <!-- <div class="mtitle">Passpost Data <span class="rws-addnewitem"><a href="jobseekers-education-add.php">Add New</a></span></div>   -->
                ...
                <div class="mtitle">Visa Details <span class="rws-addnewitem"></span></div>
                <div class="rws-mcontent">
                	...
                	<table class="rwsorderitems" cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <td><?php echo date('d-m-Y',strtotime($row['issue_date1']));?></td>
                        <td><?php echo date('d-m-Y',strtotime($row['expire_date1']));?></td>
                         <!--       <td><?php echo $row["issue_date1"]; ?></td>
                                <td><?php echo $row["expire_date1"]; ?></td>    -->
                                <td>
        ...
        <form action="" method="post">
        	<div class="rws-module">
                ...
                <div class="mtitle">Visa  Details </div>
                <br>
                    ...
                    <div class="rws-fields" >
                        <label>Select Visa</label><br/>
                        
                        US  <input  type="checkbox" name="monotreme"  onclick="onlyOne(this)"/>
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                        OTHER <input id="platypus" type="checkbox" name="monotreme"  onclick="onlyOne(this)"/>
                	...
                	<div class="rws-fields">
                        ...
                        <label> Visa Issuing Country </label><br/>
                	...
                	<!-- Row Ends -->
                     ...
                     <div class="rws-fields">
                        <div class="col-sm-12" id="mySelect">
                            <label>Type Of Visa</label><br/>
                            <input type="text" name="visa_type" value="<?php  foreach($eres as $key => $row1) { echo $row1['visa_type'];   } ?>" />
                        </div> 
                    </div>  
                    ...
                    <div class="rws-fields row">
                        <div class="col-sm-6">
                            	...
                            	<input type="date" name="issue_date1" value="<?php  foreach($eres as $key => $row1) { echo $row1['issue_date1'];   } ?>" required/>
                        </div>
                        <div class="col-sm-6">
                        	    <label>Date Of Expire</label><br/>
                            <input type="date" name="expire_date1" value="<?php  foreach($eres as $key => $row1) { echo $row1['expire_date1'];   } ?>" required/>
                        </div>
                    </div>
            		<!-- Row Ends -->                    
            ...
            <div class="rws-fields row">
               ...
               <input type="button" value="Next" onClick="document.location.href='jobseekers-cdc.php'" class="rwsbutton width_100" />  
                </div>
            </div>
      </form>   
