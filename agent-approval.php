...
<div class="rws-userpages">
	<div class="rws-userpagesinner">
		<div class="container"><h1>Agent Account Approval</h1></div>
	</div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <a href="javascript:void(0)">Agent Account Approval</a>
            </div>
        </div>
    </div>
</div>        
...
<div class="rws-maincontentinner">
	...
	$query_val = "SELECT * FROM `ss_agent` WHERE `id` =".$validateid;
...

	{
...

		{
			...
			$error_message = '<div id="rws-formsuccess">Your account has already been approved. Please log in!</div>';	
		...
		{	
			...
			$qvalup = "UPDATE `ss_agent` SET `approval` = '1' WHERE `id` =".$validateid;

			$result_valup = $db->query($qvalup);

			$error_message = '<div id="rws-formsuccess"><p>Hello User,<br /><br />			

			Your '.$sitename.' account has been successfully approved.
