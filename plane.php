  ...
  foreach($rowlist as $key => $row) {
    ...
    <div class="col-lg-4 col-md-12 mb-4">
            ...
            <div class="card-body shadow-lg p-3 mb-5 bg-body-tertiary rounded bg-white" style="border-radius: 2rem; padding: 10px 50px; ">
              ...
              <button class="btn" style="border-radius:70px;color:black;"><a type="submit" id="pay"  href="pay.php?plan_name=<?php echo  $row['plan_name']?>&&plan_price=<?php echo $row['plan_price']?>&&jobes_no=<?php echo  $row['jobes_no']?>">Sign Up</a></button>
               </div>
               </div>
              </div>
            </div>
