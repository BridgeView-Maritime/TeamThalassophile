...
$bcontract=$grow['contract'];
 ...
 //echo $iquery;exit();
    ...
    $ssubject ="New candidate applied on Teamthalassophile - jobid : Thala".$cms_jobid." ";
    $table = "

    <p style='margin-left:10px;font-size: 15px;'>New candidate applied on jobid : Thala".$cms_jobid."</p>
...
<div class="page-ads box" style="background-color:#bb9d9d3d;padding:30px;";>         
        ...
        <?php  //  foreach($grow as $key => $row) {  ?>
                <h3 style="color:#0079ab;">Hello ... <?php echo ucwords($_SESSION["USER"]['Fullname']); ?>  ,<br> Are you sure you want to apply for the post of </h3>
