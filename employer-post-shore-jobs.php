...
if(isset($_POST["rwsformsubmit"]))
{
	...
	if (empty($_POST['benefits']) ) 		{	$errors[]="Please fill out the benefits field.";		}
	...
	if (empty($_POST['description']) ) 		{	$errors[]="Please fill out the start year field.";		}
	...
	if(empty($errors)) 
	{
			...
			{
				$update_query = "INSERT INTO `ss_employer_jobs` SET emp_id = '$emp_id', section = 'Shore', jobtitle = '$jobtitle', category = '$category', job_type = '$job_type', location = '$location', description = '$description', compensation_from = '$compensation_from', compensation_to = '$compensation_to', benefits = '$benefits', how_to_appy = '$how_to_appy', start_date = '$start_date', end_date = '$end_date', ship_type = '$ship_type', client = '$client', area_of_operation = '$area_of_operation', currency = '$currency', period = '$period', skills = '$skills', experience = '$experience', person_name = '$person_name', person_email = '$person_email', person_phone = '$person_phone', salary_terms = '$salary_terms', salary_terms_doc = '".$imageuploadname[1]."', status = '1', sort_order = '0', add_date = '$gtcurrenttime'";
				$update_result = $db->query($update_query);	
...
{
	$pagetitle = "Update Shore Job Details";
}
else
{
	$pagetitle = "Add New Shore Job";
}
        	...
        	<div class="rws-module">
                ...
                <?php echo $gt_msgerror; if(isset($_SESSION["GTMsgtoUser"])) { echo $_SESSION["GTMsgtoUser"]; unset($_SESSION["GTMsgtoUser"]); }?>
                    ...
                    <div class="rws-fields">
                    	...
                    	<?php echo todisplay($array_category_shore, "category", "Select Category", $_SESSION['myForm']["category"], $onchange="required"); ?>
                    </div>
                    <!-- Row Ends -->
                    ...
                    <div class="rws-fields row">    
                        ...
                        <div class="col-sm-6">
                        	...
                        	<?php echo todisplaymultiplewithgroupname($array_aus_location, $array_newze_location, "", "", "", "", "Australia, New Zealand", 'location', "Select Location", $_SESSION['myForm']["location"], $onchange=""); ?>
                        </div>        
                    </div>
            		<!-- Row Ends --> 
                    ...
                    <div class="rws-fields">
                    	<label class="rws-flabel"><span>*</span>Benefits</label>
                        <input type="text" name="benefits" id="benefits" value="<?php echo $_SESSION['myForm']["benefits"];?>" placeholder="Benefits" required />
                    </div>
                	<!-- Row Ends -->
