...
<div class="rws-maincontentinner">
    ...
    <div class="row">
        ...
        <?php
			...
			$select_query 		= 'SELECT * FROM `ss_jobseekers_certificates` WHERE js_id = "'.$_SESSION["USER"]['ID'].'"';
			$select_result 		= $db->query($select_query);
       ...
       <b style="padding-left:550px;">Download Your CV :  </b> <a href="jobseekers-generate-cv-pdf.php" target="_blank" class="btn btn-secondary gpdf" style="background-color:#0079ab !important; color:white;"><i class="fa fa-file-pdf-o" style="font-size: large;"></i>Generate PDF</a>
        ...
        <div class="mtitle" align="center";><b>RESUME</b></div>
                    	...
                    	<div class="rws-cvheaderdata">
                        	<div class="row">
                            	<div class="col-sm-3">
                                	...
                                	<?php if(!empty($_SESSION["USER"]['Picture'])) { echo '<img  
                                        src="'.$baseurl.$_SESSION["USER"]['Picture'].'" title="" />'; } else {  echo '<img  src="'.$baseurl.'images/no-pic-com-logo.jpg" title="" />'; } ?>
...
<div class="rws-generalcvinfo">
   ...
   <?php // } ?>	        
            ...
            <table border='1' cellspacing='0' style='text-align-last: center;background:white;color:black;font:normal 18px sans-serif;margin-left:10px;width: 90%;'>    
                ...
                <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_edu["start_year"])); ?></td>

                <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_edu["end_year"])); ?></td>
...
<!--   <td style='padding: 5px;font-size:15px'><?php echo $array_all_certificate[$val_cer["cocname"]]; ?></td>  -->
       ...
       <td style='padding: 5px;font-size:15px'>	<?php echo  date('d-m-Y',strtotime($val_cer["cocissue"])); ?></td>

       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_cer["cocexp"])); ?></td>
...
<div class="rws-generalcvinfo">
   <table border='1' cellspacing='0' style='text-align-last: center;background:white;color:black;font:normal 18px sans-serif;margin-left:10px;width: 90%;'>    
       ...
       <td style='padding: 5px;font-size:15px'>	<?php echo  date('d-m-Y',strtotime($val_off["issuedate"])); ?></td>

       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_off["expdate"])); ?></td>
...
<div class="rws-generalcvinfo">
   <table border='1' cellspacing='0' style='text-align-last: center;background:white;color:black;font:normal 18px sans-serif;margin-left:10px;width: 90%;'>    
       ...
       <td style='padding: 5px;font-size:15px'>	<?php echo  date('d-m-Y',strtotime($val_other["issuedate"])); ?></td>

       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_other["expdate"])); ?></td>
...
<!---------start---------new code for table Certificates STCW--------------->
...
<div class="rws-generalcvinfo">
   <table border='1' cellspacing='0' style='text-align-last: center;background:white;color:black;font:normal 18px sans-serif;margin-left:10px;width: 90%;'>    
       ...
       <td style='padding: 5px;font-size:15px'>	<?php echo  date('d-m-Y',strtotime($val_stcw["issuedate"])); ?></td>

       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_stcw["expdate"])); ?></td>
...
<div class="rws-generalcvinfo">
   <table border='1' cellspacing='0' style='text-align-last: center;background:white;color:black;font:normal 18px sans-serif;margin-left:10px;width: 90%;'>    
       ...
       <td style='padding: 5px;font-size:15px'>	<?php echo  date('d-m-Y',strtotime($val_pass["issue_date"])); ?></td>

       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_pass["expire_date"])); ?></td>
...
<div class="rws-generalcvinfo">
   <table border='1' cellspacing='0' style='text-align-last: center;background:white;color:black;font:normal 18px sans-serif;margin-left:10px;width: 90%;'>    
       ...
       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_cdc["issue_date2"])); ?></td>

       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_cdc["expire_date2"])); ?></td>
...
<div class="rws-generalcvinfo">
   <table border='1' cellspacing='0' style='text-align-last: center;background:white;color:black;font:normal 18px sans-serif;margin-left:10px;width: 90%;'>    
       ...
       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_visa["issue_date1"])); ?></td>

       <td style='padding: 5px;font-size:15px'><?php echo  date('d-m-Y',strtotime($val_visa["expire_date1"])); ?></td>
