...
if ($_POST['rwstxtsearch']!="")
{
	...
	$sql = "SELECT t1.service_id, t1.name FROM ss_services as t1 WHERE t1.service_id > 0 AND t1.name LIKE '$filter_name%' AND t1.service_id IN ($services_category) GROUP BY t1.service_id ORDER BY t1.name ASC LIMIT 0,10 ";
