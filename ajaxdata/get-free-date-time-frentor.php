...
foreach($daterange as $key=>$val)
{
	...
	if($foundnum>0)
	{
		$rowlist = $rs->rows;
		$j=1; 
		$textinbody ='<div class="gtsselecthead"><div class="row"><div class="col-sm-7">Availability</div><div class="col-sm-5  gttextright">Choose</div></div></div>';
		...
		{		
			...
			if(!empty($_SESSION['ScheduleClass'][$val."_".$row["service_provider_availablity_id"]]))
			{
				$textinbody .= '<div class="gtfieldvalue">
								<div class="row">
									...
									<div class="col-sm-5 gttextright"><input type="hidden" name="gtscheduledate" class="gtscheduledate" value="'.$val.'"/>
									<input type="hidden" name="gtschedulestart" class="gtschedulestart" value="'.$row["start_time"].'"/>
									<input type="hidden" name="gtscheduleend" class="gtscheduleend" value="'.$row["end_time"].'"/>
									<input type="hidden" name="gtscheduleorder_id" class="gtscheduleorder_id" value="'.$order_id.'"/>
									<input type="hidden" name="totalhours" class="gttotalhours" value="'.$totalhours.'"/>
									<input type="hidden" name="gtschedulesp_id" class="gtschedulesp_id" value="'.$sp_id.'"/>
									<input type="hidden" name="gtschedulesp_name" class="gtschedulesp_name" value="'.$sp_name.'"/>
									<input type="checkbox" name="gtscheduletime" id="gtscheduletime_'.$row["service_provider_availablity_id"].'" class="gtscheduletime" value="'.$row["service_provider_availablity_id"].'" checked="checked"/>
									</div>
								</div>
								</div>';
			}
			else
			{
				$textinbody .= '<div class="gtfieldvalue">
								<div class="row">
									...
									<input type="hidden" name="gtschedulesp_id" class="gtschedulesp_id" value="'.$sp_id.'"/>
									<input type="hidden" name="gtschedulesp_name" class="gtschedulesp_name" value="'.$sp_name.'"/>
									<input type="checkbox" name="gtscheduletime" id="gtscheduletime_'.$row["service_provider_availablity_id"].'" class="gtscheduletime" value="'.$row["service_provider_availablity_id"].'"/>
									</div>
								</div>
								</div>';
			}
			...
			else
			{
				$textinbody .= '<div class="gtfieldvalue">
								<div class="row">
									<div class="col-sm-7">From '.date("h A", strtotime($val.' '.$row["start_time"])).' To '.date("h A", strtotime($val.' '.$row["end_time"])).'</div>
									<div class="col-sm-5 gttextright">Unavailable<input type="hidden" name="gtscheduledate" class="gtscheduledate" value="'.$val.'"/>
									<input type="hidden" name="gtschedulestart" class="gtschedulestart" value="'.$row["start_time"].'"/>
									<input type="hidden" name="gtscheduleend" class="gtscheduleend" value="'.$row["end_time"].'"/>
									<input type="hidden" name="gtscheduleorder_id" class="gtscheduleorder_id" value="'.$order_id.'"/>
									<input type="hidden" name="totalhours" class="gttotalhours" value="'.$totalhours.'"/>
