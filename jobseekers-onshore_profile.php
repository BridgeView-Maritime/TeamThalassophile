    ...
    <div class="row">
        ...
        <form action="" method="post" enctype="multipart/form-data" name="gtregisterforms" id="gtregisterforms">
            ...
            <div class="rws-module">
                <div class="mtitle">ONSHORE INFO</div>
                <div class="rws-mcontent">
                    ...
                    <!--
                         <script>
                            ...
                            c.onchange = function() {
                            if (c.checked == true) {document.getElementById('mySelect').style.display = 'inline';}
                            else {document.getElementById('mySelect').style.display = 'none';
                            }
                            }
                            }
                    ...
                    <div class="rws-fields">
                        ...
                        YES <input id="platypus" type="checkbox" name="monotreme" value="platypus" onclick="onlyOne(this)"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        NO  <input  type="checkbox" name="monotreme"  onclick="onlyOne(this)"/>
                         <?php
