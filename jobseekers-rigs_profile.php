    ...
    <div class="row">
        ...
        <form action="" method="post" enctype="multipart/form-data" name="gtregisterforms" id="gtregisterforms">
            ...
            <div class="rws-module">
                <div class="mtitle">RIGS / DRILLING RIGS INFO</div>
                <div class="rws-mcontent">
                    ...
                    <div class="rws-fields row">    
                        <div class="col-sm-6">
                            <label class="rws-flabel">First Name<span>*</span></label>
                    ...
                    <div class="rws-fields">
                        <label>Select Rank</label><br/>
                         ...
                         <?php
                            ...
                            $rankname="select * from ss_rigsrank  where rankname!='' GROUP BY rankname order by rankname ASC";
