...
if(isset($_POST["rwsformsubmit"]))
{
	...
	elseif(tocheckoldpwdusers($_POST['oldpassword'], "ss_employer", $_SESSION["EMP"]['ID'])==0) {$errors[]='Please fill out the correct old password field.';}
	...
	if(empty($errors)) 
	{
			...
			$update_query = "UPDATE `ss_employer` SET password = '$password' WHERE `id`=".$_SESSION["EMP"]['ID'];
