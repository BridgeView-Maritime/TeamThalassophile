...

{
	...
	{	
		...
		$query="SELECT * FROM `ss_agent` WHERE `email`='$email' ";	
		...
		
		{
		  ...
		  '.$emailfooter;
				...
				sendmail($admin_fromname,$admin_fromemail,$subject,$email,
				$mail_cc,$mail_bcc,$body,$resumefilename);
			...
			{	
				...
				$query_insert = "UPDATE `ss_agent` SET password = '$password' WHERE `id`='$userid'";
...
<div class="rws-userpages">
	<div class="rws-userpagesinner">
		<div class="container"><h1>Agent Forgot Password?</h1></div>
	</div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <a href="javascript:void(0)">Agent Forgot Password?</a>
            </div>
        </div>
    </div>
</div>         
        ...
        <div class="rws-maincontentinn">
            ...
            <div class="rws-fields">
                ...
                <div class="row">
                	...
                	<div class="col-xs-6"><a href="agent-login.php">Login</a></div>

                    <div class="col-xs-6" style="text-align:right;"><a href="agent-register.php">Register</a></div>
