...
if(isset($_POST["rws-submit"]))
{
	...
	{		
			...
			$update_query = "UPDATE `ss_info_jobseeker` SET  `description`='$description'  WHERE `id`= '$post_id'";

			$update_result = $db->query($update_query);			

			$msg_result='<div id="gt-formsuccess">Information For Employer has been updated successfully.!</div>';			
...
$select_query = 'SELECT * FROM `ss_info_jobseeker` LIMIT 1';
...
$_SESSION['myForm']['description'] = stripslashes($row['description']);
	...
	$reg_title = 'Edit Information For Jobseeker';

	$reg_subtitle = 'Information For Jobseeker Edit Page';

	$reg_breadcrumb = 'Edit Information For Jobseeker';
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $baseurl; ?>master/ukc-submissions.php"><i class="fa fa-leaf"></i> Informaton For Jobseeker </a></li>
