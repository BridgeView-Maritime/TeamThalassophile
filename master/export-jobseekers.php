...
$_SESSION['myForm']="";
	...
	$reg_title = 'Export Jobseekers';
	$reg_subtitle = 'Export Jobseekers Page';
	$reg_breadcrumb = 'Export Jobseekers';
	$reg_button = 'Export';
...
?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <form role="form" name="rwsglobalform"  id="rwsglobalform" action="export-jobseekers-csv.php" method="post" enctype="multipart/form-data" target="_blank">
