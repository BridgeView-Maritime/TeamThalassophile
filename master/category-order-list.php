...
/* ----- Action Code Ends HERE ----- */
	...
	$query="SELECT t1.*, t2.firstname, t2.lastname, t2.email FROM ss_consumer_order as t1 LEFT JOIN ss_users as t2 ON t1.user_id=t2.user_id WHERE t1.order_status='1' GROUP BY t1.order_id ".$nquery;
	...
	{
		$show_firmid = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=order_id&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">ID</a>';
		$show_title = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=order_reference_number&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">PNR No.</a>';	
		$show_amount = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=totalamount&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">Amount Paid(In Rs.)</a>';		
		$show_service = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=from&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">Route</a>';		
		$show_package = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=start_time&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">Start Time</a>';
		$show_servicep = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=end_time&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">End Time</a>';
		$show_total_hours = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=journey_date&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">Journey Date</a>';
		$show_duration = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=mobile&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">Mobile</a>';		
		$show_status = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=order_status&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">Order Status</a>';
		$show_date_added = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=dateoforder&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">Order Date</a>';
	...
	{
		$show_firmid = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=order_id&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">ID</a>';
		$show_title = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=order_reference_number&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">PNR No.</a>';	
		$show_amount = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=totalamount&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">Amount Paid(In Rs.)</a>';		
		$show_service = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=from&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">Route</a>';		
		$show_package = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=start_time&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">Start Time</a>';
		$show_servicep = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=end_time&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">End Time</a>';
		$show_total_hours = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=journey_date&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">Journey Date</a>';
		$show_duration = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=mobile&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">Mobile</a>';		
		$show_status = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=order_status&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">Order Status</a>';
		$show_date_added = '<a href="category-order-list.php?page=gclt&PageNo='.$pagenum.'&field=dateoforder&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">Order Date</a>';
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                       Booking List - Successful
                        <small>Front-End Booking List - Successful</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo $baseurl; ?>master/dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Booking List - Successful</li>
                    </ol>
                </section>
										...
										$j=1; foreach($rowlist as $key => $row) { 
										 ...
										 ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="category-order-details.php?fid=<?php echo $row["order_id"]; ?>&goback=1">Details</a></td>
                                            </tr> 
                                         <?php  $j++; } ?>  
                                        </tbody>
                                        <tfoot>
