...
/* ----- Action Code Ends HERE ----- */
	...
	$query="SELECT t1.*, t2.firstname, t2.lastname, t2.email FROM ss_consumer_order as t1 LEFT JOIN ss_users as t2 ON t1.user_id=t2.user_id WHERE t1.order_status='0' AND t1.payment_method='paytm' GROUP BY t1.order_id ".$nquery;
	...
	if($orderby != "" && $orderby == "ASC")
	{
		...
		$show_amount = '<a href="category-order-pending-list.php?page=gclt&PageNo='.$pagenum.'&field=totalamount&order=DESC&search='.$search_txt.'" title="Click to Sort in desending order.">Amount</a>';		
	...
	else
	{
		...
		$show_amount = '<a href="category-order-pending-list.php?page=gclt&PageNo='.$pagenum.'&field=totalamount&order=ASC&search='.$search_txt.'" title="Click to Sort in desending order.">Amount</a>';		
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                      	Booking List - Paytm Pending
                        <small>Front-End Booking List - Paytm Pending</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo $baseurl; ?>master/dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Booking List - Paytm Pending</li>
                    </ol>
                </section>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
										...
										$j=1; foreach($rowlist as $key => $row) { 
											...
											{ 
												...
												$sendpaymentlink3 = '<a href="'.$baseurl.'master/category-order-details-paytm-link.php?fid='.$row["order_id"].'&type=confirm">Confirm</a> | ';
												$sendpaymentlink4 = '<a href="'.$baseurl.'master/category-order-details-paytm-link.php?fid='.$row["order_id"].'&type=send">Paytm Link</a> | ';
											}
											else
											{
												$sendpaymentlink = "";
										 ...
										 ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row["totalamount"]; ?> Rs.</td>
                                                <td><?php echo $row["start_time"]; ?></td>
                                                <td><?php echo $row["journey_date"]; ?></td>                                                 
                                                <td <?php echo $status_cls; ?>><?php echo $status; ?></td>
                                                <td><?php echo $sendpaymentlink; ?><?php echo $sendpaymentlink3; ?><?php echo $sendpaymentlink4; ?><a href="category-order-details.php?fid=<?php echo $row["order_id"]; ?>&goback=0">Details</a></td>
                                            </tr> 
                                         <?php  $j++; } ?>  
                                        </tbody>
                                        <tfoot>
                                    ...
                                    <div class="row"  style="padding-top:10px; padding-bottom:10px;">
                                    	...
                                    	<div class="col-xs-6">
                                        	...
                                        	<div class="dataTables_info" id="example1_info">
												...
												<?php if($foundnum>0) { echo 'Showing  '.($start+1).' to '.($start+$per_page).' of '.$foundnum.' entries'; } else { echo '<strong style="color:#FF0000;">There is no consumer booking pending via paytm.</strong>'; }?>
