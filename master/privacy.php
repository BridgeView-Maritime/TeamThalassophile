...
if(isset($_POST["rws-submit"]))
{
	...
	{		
			...
			$update_query = "UPDATE `ss_privacy` SET  `description`='$description'  WHERE `id`= '$post_id'";

			$update_result = $db->query($update_query);			

			$msg_result='<div id="gt-formsuccess"> Priacy Policy has been updated successfully.!</div>';			
...
$select_query = 'SELECT * FROM `ss_privacy` LIMIT 1';
...
$_SESSION['myForm']['description'] = stripslashes($row['description']);
	...
	$reg_title = 'Edit Privacy Policy';

	$reg_subtitle = 'Privacy Policy Edit Page';

	$reg_breadcrumb = 'Edit Privacy Policy';
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $baseurl; ?>master/ukc-submissions.php"><i class="fa fa-leaf"></i> Privacy Policy </a></li>
                                ...
                                <!-- form start -->
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                            	<textarea name="description" rows="15" id="rwscontenteditor" placeholder="Description">
