...
if(isset($_POST["rws-submit"]))
{
    ...
    {       
            ...
            $update_query = "UPDATE `ss_aboutus` SET  `description`='$description'  WHERE `id`= '$post_id'";

            $update_result = $db->query($update_query);         

            $msg_result='<div id="gt-formsuccess">Information For About Us has been updated successfully.!</div>';          
...
$select_query = 'SELECT * FROM `ss_aboutus` LIMIT 1';
...
$_SESSION['myForm']['description'] = stripslashes($row['description']);
    ...
    $reg_title = 'Edit Information For About Us';

    $reg_subtitle = 'About Us Edit Page';

    $reg_breadcrumb = 'Edit Information For About Us';
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $baseurl; ?>master/ukc-submissions.php"><i class="fa fa-leaf"></i> About Us </a></li>
