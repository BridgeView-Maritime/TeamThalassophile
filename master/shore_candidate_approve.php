...
<?php include('header.php'); $gtpage = 'candidate_approve'; $listjs = 1; 
...
/* ----- Action Code Ends HERE ----- */
  ...
  // echo "hiiii";exit;
        ...
        $query="SELECT * FROM ss_jobseekers WHERE id > 0 AND admin_approval='0' AND status='1' AND cv_category='Shore' ";

       // echo $query;exit;
    
    }else{

        $query="SELECT * FROM ss_jobseekers WHERE id > 0 AND admin_approval='0' AND status='1' AND cv_category='Shore' ".$nquery ;
             ...
             <!-------------------end model---------------------------------------------->
                            ...
                            <div class="box"><!-- /.box-header -->
                                ...
                                <div class="box-body table-responsive">
                                	...
                                	<?php if($foundnum>0) { echo '<div class="rws-messageshow">'.$foundnum.' '.trim($_GET["search_txt"]).'  Candidate Need Approval </div>'; } ?>
                ...
                <p>Candidate register with job alert [<?php echo togetjobseekersdata("", $condition=" `subscribe`='1' ");?>]</p>
                                ...
                                <?php if($foundnum>0) { ?>
                                    ...
                                    ?>
                                                ...
                                                <button type="submit" style="margin:2px;" data-toggle="tooltip" title="Click Here To Deactivate" class="btn btn-danger deactivateuser" id="<?php echo $row['id'];?>" >Deactivate</button>   </td>
                                            </tr> 
                     ...
                     <br>  
                     <?php if($foundnum>0) { ?>             
                <button type="submit"  id="activate" class="btn btn-primary" >Activate</button>
                    <?php } ?>
