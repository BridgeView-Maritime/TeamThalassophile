...
if(isset($_POST["rws-submit"]))
{
	...
	{		
			...
			$update_query = "UPDATE `ss_info_emp` SET  `description`='$description'  WHERE `id`= '$post_id'";
...
$select_query = 'SELECT * FROM `ss_info_emp` LIMIT 1';
...
$_SESSION['myForm']['description'] = stripslashes($row['description']);
	...
	$reg_title = 'Edit Information For Employer';

	$reg_subtitle = 'Information For Employer Edit Page';

	$reg_breadcrumb = 'Edit Information For Employer';
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $baseurl; ?>master/ukc-submissions.php"><i class="fa fa-leaf"></i> Informaton For Employer </a></li>
