                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <input type="hidden" name="duration" id="duration" value="<?php echo $_SESSION['myForm']['duration']; ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="ui-widget">
                                                    <input type="text" name="service_provider" value="<?php echo $_SESSION['myForm']['service_provider_name']; ?>" class="form-control ui-autocomplete-input" size="100" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
                                                    <input type="hidden" name="service_provider_id" value="<?php echo $_SESSION['myForm']['service_provider_id']; ?>">    
                                                </div>
                                                <p>** Only those frentor list will come who added working hour from their front-end panel.</p>
                                            </div>
                                        </div>
