...
<div class="rws-userpages">
	<div class="rws-userpagesinner">
		<div class="container"><h1>Agent Account Validation</h1></div>
	</div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <a href="javascript:void(0)">Agent Account Validation</a>
            </div>
        </div>
    </div>
</div>        
...
<div class="rws-maincontentinner">
...

	{
		...
		{	
			...
			$qvalup = "UPDATE `ss_agent` SET `validate` = '1' WHERE `id` =".$validateid;
